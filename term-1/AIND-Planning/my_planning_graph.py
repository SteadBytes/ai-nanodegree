...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        # of the S nodes
        self.s_levels.append(set())  # Init new level of states
